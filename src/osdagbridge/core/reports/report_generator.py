...
\begin{longtable}{|>{\centering\arraybackslash}C{0.8cm}|p{3.8cm}|>{\centering\arraybackslash}C{3.6cm}|>{\centering\arraybackslash}C{2.0cm}|>{\centering\arraybackslash}C{1.8cm}|>{\centering\arraybackslash}C{1.8cm}|>{\centering\arraybackslash}C{2.2cm}|}
\hline
\textbf{S.N.} & \textbf{Item Description} & \textbf{Volume} & \textbf{Quantity} & \textbf{Total Volume} & \textbf{Weight (MT)} & \textbf{Total Weight (MT)} \\
\hline
1 & Structural Steel (IS 2062) for Girders & """ + str(input_dict.get("steel_girders_vol_formula", "---")) + r""" & """ + str(input_dict.get("steel_girders_qty", "---")) + r""" & """ + str(input_dict.get("steel_girders_vol_total", "---")) + r""" & """ + str(input_dict.get("steel_girders_wt_single", "---")) + r""" & """ + str(input_dict.get("steel_girders_wt_total", "---")) + r""" \\
\hline
2 (a) & Cross Bracing - Top Chord & """ + str(input_dict.get("bracing_top_vol_formula", "---")) + r""" & """ + str(input_dict.get("bracing_top_qty", "---")) + r""" & """ + str(input_dict.get("bracing_top_vol_total", "---")) + r""" & """ + str(input_dict.get("bracing_top_wt_single", "---")) + r""" & """ + str(input_dict.get("bracing_top_wt_total", "---")) + r""" \\
\hline
2 (b) & Cross Bracing - Bottom Chord & """ + str(input_dict.get("bracing_bot_vol_formula", "---")) + r""" & """ + str(input_dict.get("bracing_bot_qty", "---")) + r""" & """ + str(input_dict.get("bracing_bot_vol_total", "---")) + r""" & """ + str(input_dict.get("bracing_bot_wt_single", "---")) + r""" & """ + str(input_dict.get("bracing_bot_wt_total", "---")) + r""" \\
\hline
2 (c) & Cross Bracing - Diagonal & """ + str(input_dict.get("bracing_diag_vol_formula", "---")) + r""" & """ + str(input_dict.get("bracing_diag_qty", "---")) + r""" & """ + str(input_dict.get("bracing_diag_vol_total", "---")) + r""" & """ + str(input_dict.get("bracing_diag_wt_single", "---")) + r""" & """ + str(input_dict.get("bracing_diag_wt_total", "---")) + r""" \\
\hline
3 & Concrete (M40) for Deck Slab & """ + str(input_dict.get("concrete_deck_vol_formula", "---")) + r""" & """ + str(input_dict.get("concrete_deck_qty", "---")) + r""" & """ + str(input_dict.get("concrete_deck_vol_total", "---")) + r""" & """ + str(input_dict.get("concrete_deck_wt_single", "---")) + r""" & """ + str(input_dict.get("concrete_deck_wt_total", "---")) + r""" \\
\hline
4 & Reinforcement Steel (Fe 500) & """ + str(input_dict.get("rebar_deck_vol_formula", "---")) + r""" & """ + str(input_dict.get("rebar_deck_qty", "---")) + r""" & """ + str(input_dict.get("rebar_deck_vol_total", "---")) + r""" & """ + str(input_dict.get("rebar_deck_wt_single", "---")) + r""" & """ + str(input_dict.get("rebar_deck_wt_total", "---")) + r""" \\
\hline
5 & Shear Stud Connectors & """ + str(input_dict.get("shear_studs_vol_formula", "---")) + r""" & """ + str(input_dict.get("shear_studs_qty", "---")) + r""" & """ + str(input_dict.get("shear_studs_vol_total", "---")) + r""" & """ + str(input_dict.get("shear_studs_wt_single", "---")) + r""" & """ + str(input_dict.get("shear_studs_wt_total", "---")) + r""" \\
\hline
6 & Crash Barrier & """ + str(input_dict.get("crash_barrier_vol_formula", "---")) + r""" & """ + str(input_dict.get("crash_barrier_qty", "---")) + r""" & """ + str(input_dict.get("crash_barrier_vol_total", "---")) + r""" & """ + str(input_dict.get("crash_barrier_wt_single", "---")) + r""" & """ + str(input_dict.get("crash_barrier_wt_total", "---")) + r""" \\
\hline
\end{longtable}
"""
