...
-----------------------
Popup tab summarising an Overall Design Check (parallel weight optimisation):
...
populated by ``optimize_parallel``.
"""
...
class OptimizationReportDialog(QDialog):
    ...
    def __init__(self, records: List[dict], summary: Optional[dict] = None, parent=None):
        ...
        note = QLabel(
            "Every design tried by the parallel search is listed below, including "
