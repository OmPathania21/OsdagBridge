...
class CustomWindow(QWidget):
    ...
    def _run_threaded_optimization(self, base_input_dict: dict) -> dict:
        """
        Run the threaded weight optimisation, streaming x/N progress and
        ...
        """
        from osdagbridge.core.optimizer.threaded_bridge_optimizer import optimize_threaded
        ...
        bridge_logger.info(
            ...
            f"across {GENERATIONS + 1} round(s) ..."
        )
    ...
    def common_design_func(self, trigger: str, target_tab: str = None):
        ...
        if trigger == "Design":
            ...
            try:
                # Optimized mode: run the threaded weight optimisation first and
                ...
                if self._is_optimized_run():
                    design_input = self._run_threaded_optimization(self.input_dict)
